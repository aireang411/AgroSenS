...
import dpvService from '../services/dpvService';
 ...
 */
async function crearSensor(req: CustomRequest, res: Response): Promise<void> {
 ...
 * GET /api/v1/sensores
 */
async function obtenerSensores(req: CustomRequest, res: Response): Promise<void> {
    const idUsuario = req.usuario?.id_usuario;
 ...
 */
async function obtenerSensor(req: CustomRequest, res: Response): Promise<void> {
    const { id } = req.params;
    const idUsuario = req.usuario?.id_usuario;
 ...
 */
async function actualizarSensor(req: CustomRequest, res: Response): Promise<void> {
    const { id } = req.params;
    const idUsuario = req.usuario?.id_usuario;
 ...
 */
async function ingresarLectura(req: CustomRequest, res: Response): Promise<void> {
    const { id } = req.params;
    const idUsuario = req.usuario?.id_usuario;
 ...
 */
async function obtenerLecturas(req: CustomRequest, res: Response): Promise<void> {
    const { id } = req.params;
    const idUsuario = req.usuario?.id_usuario;
 ...
 */
async function simularLecturaDesdeEvento(req: CustomRequest, res: Response): Promise<void> {
    const idUsuario = req.usuario?.id_usuario;
    const {
        id_lote,
        tipo_evento,
 ...
 */
async function eliminarSensor(req: CustomRequest, res: Response): Promise<void> {
    const { id } = req.params;
    const idUsuario = req.usuario?.id_usuario;
