 ...
 */
async function obtenerRecomendacion(req: CustomRequest, res: Response): Promise<void> {
 ...
 */
async function obtenerRecomendacionesPorLote(req: CustomRequest, res: Response): Promise<void> {
    ...
    try {
        ...
        const recomendacionesFormateadas = recomendaciones.map((r: any) => ({
            ...r,
 ...
 */
async function obtenerRecomendaciones(req: CustomRequest, res: Response): Promise<void> {
    const idUsuario = req.usuario?.id_usuario;
 ...
 */
async function obtenerEstadisticas(req: CustomRequest, res: Response): Promise<void> {
    const idUsuario = req.usuario?.id_usuario;
