 ...
 */
async function crearInvernadero(req, res) {
 ...
 */
async function obtenerInvernaderos(req, res) {
    const idUsuario = req.usuario.id_usuario;
 ...
 */
async function obtenerInvernadero(req, res) {
    const { id } = req.params;
    const idUsuario = req.usuario.id_usuario;
 ...
 */
async function actualizarInvernadero(req, res) {
    const { id } = req.params;
 ...
 */
async function eliminarInvernadero(req, res) {
    const { id } = req.params;
    const idUsuario = req.usuario.id_usuario;
